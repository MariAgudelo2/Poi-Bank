            ...
            <div class="container px-5 my-5">
                <div class="row gx-5">
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <h2 class="h4 fw-bolder">Cuenta corriente</h2>
                        <p>La cuenta corriente está diseñada para personas que deben hacer constantes movimientos 
                            de dinero. Es decir, recibir varios depósitos, realizar muchas transferencias o hacer 
                    ...
                    <div class="col-lg-4">
                        ...
                        <h2 class="h4 fw-bolder">Cuenta suprema</h2>
