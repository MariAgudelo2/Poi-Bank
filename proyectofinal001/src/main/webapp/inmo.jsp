    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container px-5">
                <a class="navbar-brand" href="#!">Hoi Inmo</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="#!">Home</a></li>
                        <li class="nav-item"><a class="nav-link" href="crearCuenta.jsp">Publica tu Propiedad</a></li>
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            <h1 class="display-5 fw-bolder text-white mb-2">Hoi Inmo</h1>
                            <p class="lead text-white-50 mb-4">Somos más que una inmobiliaria</p>
            ...
            <div class="container px-5 my-5">
                <div class="row gx-5">
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <h2 class="h4 fw-bolder">Realiza esa compra de tus sueños</h2>
                        <p>Accede a un catálogo internacional con nosotros 😎</p>
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <h2 class="h4 fw-bolder">Vende con los mejores</h2>
                        <p>Promociona tu propiedad y consigue esa venta</p>
                        <a class="text-decoration-none" href="#!">
                    ...
                    <div class="col-lg-4">
                        ...
                        <h2 class="h4 fw-bolder">Hora de las subastas!</h2>
                        <p>Es hora de ponernos competitivos, participa en grandes subastas 🤑 </p>
                        <a class="text-decoration-none" href="#!">
        ...
        <footer class="py-5 bg-dark">
            <div class="container px-5"><p class="m-0 text-center text-white">Copyright &copy; Hoi-Inmo 2024</p></div>
        </footer>
        <!-- Bootstrap core JS-->
